...
# Format strings with color indicators and %m for misc (unpushed commits)
...
# Register custom hooks for unpushed commits
zstyle ':vcs_info:git*+set-message:*' hooks git-unpushed
